...
import duypn.classes.converters.StringConverter;
...
public class UpdateContestController extends HttpServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = ContestDAO.Instance().update(contest);
            if(!check){
                request.setAttribute("ERROR", "Update failed, please contact admin");
            }
        } catch (Exception e){
            e.printStackTrace();
            log(e.getMessage());
        } finally {
            response.sendRedirect(ActionHelper.Match("LoadContest"));
        }
