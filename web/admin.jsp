                                        ...
                                        <ul class="nav nav-pills nav-pills--brand m-nav-pills--align-right m-nav-pills--btn-pill m-nav-pills--btn-sm"
                                            ...
                                            <li class="nav-item m-tabs__item">
                                                <a class="nav-link m-tabs__link active show" data-toggle="tab"
                                                   href="#m_widget2_tab1_content" role="tab" aria-selected="true">
                                                    Today
                                                </a>
                                            </li>
                                            <li class="nav-item m-tabs__item">
                                                <a class="nav-link m-tabs__link" data-toggle="tab"
                                                   href="#m_widget2_tab2_content" role="tab" aria-selected="false">
                                                    Month
                                                </a>
                                            </li>
                                        </ul>
                                                        ...
                                                        <div class="m-widget4__progress-wrapper">
                                                            ...
                                                            <div class="progress m-progress--sm">
                                                                <div class="progress-bar bg-danger" role="progressbar"
                                                                     style="width: 63%;" aria-valuenow="25"
                                                        ...
                                                        <div class="m-widget4__progress-wrapper">
                                                            ...
                                                            <div class="progress m-progress--sm">
                                                                <div class="progress-bar bg-success" role="progressbar"
                                                                     style="width: 33%;" aria-valuenow="45"
                                                        ...
                                                        <div class="m-widget4__progress-wrapper">
                                                            ...
                                                            <div class="progress m-progress--sm">
                                                                <div class="progress-bar bg-brand" role="progressbar"
                                                                     style="width: 13%;" aria-valuenow="65"
                                                ...
                                                <div class="m-widget4__item">
                                                    ...
                                                    <div class="m-widget4__progress">
                                                        <div class="m-widget4__progress-wrapper">
                                                            ...
                                                            <div class="progress m-progress--sm">
                                                                <div class="progress-bar bg-danger" role="progressbar"
                                                                     style="width: 93%;" aria-valuenow="25"
...
<c:if test="${not check}">
    <c:url value="MainController" var="Error">
        <c:param name="action" value="Error"></c:param>
        <c:param name="ErrorInfo" value="Login with role admin for use this feature"></c:param>
    </c:url>
