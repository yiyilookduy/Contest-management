<%-- 
    Document   : Login
    Created on : Oct 2, 2018, 3:30:55 PM
    Author     : duypnse63523
--%>
...
<c:if test="${empty sessionScope.Account}" var="check">
        ...
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
            <div class="m-login__container">
                ...
                <div class="m-login__signin">
                    ...
                    <form class="m-login__form m-form" action="MainController" method="POST" onsubmit="return (validForm())">
                        ...
                        <div class="m-login__form-action">
                            <input type="submit" name="action" value="Login" id="m_login_signin_submit"
...
<c:if test="${not check}">
    <c:url value="admin.jsp" var="Admin"/>
